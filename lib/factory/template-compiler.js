    ...
    compile({
        ...
        return new BuildBlueprint({
            ...
            metadata: {
                ...
                languageContext: request.languageContext ?? request.project?.languageContext ?? null,
                stack: {
                    backend: chosenTemplate.backend,
                    frontend: chosenTemplate.frontend,
                    database: chosenTemplate.database,
            ...
            stackMetadata: {
                backend: {
                    ...
                    defaultLocale: request.languageContext?.generatedApplicationDefaultLocale ?? "en-US",
                    supportedLocales: request.languageContext?.supportedLocales ?? ["en-US"]
                },
                frontend: {
