...
import ApprovalExecutionService from "./approval-execution-service.js";
...
export default class TelegramApprovalService {
    constructor({
        ...
        approvalExecutionService = new ApprovalExecutionService(),
    ...
    approve(id = "", input = {}) {
        ...
        const current = this.loadApprovalState(input.projectRoot ?? null);
        ...
        const execution = this.approvalExecutionService.execute({
            approvalId: id,
