...
- Capabilities: `authentication`, `users`, `roles`, `permissions`, `dashboard`, `notifications`, `audit-logs`, `email`, `file-storage`, `settings`, `search`, `reports`, `health`, `version`, `logging`, `crm`, `invoices`, `whatsapp`, `erp`
