...
- Capabilities: `authentication`, `users`, `roles`, `permissions`, `dashboard`, `hospital`, `notifications`, `audit-logs`, `email`, `file-storage`, `settings`, `search`, `reports`, `health`, `version`, `logging`
