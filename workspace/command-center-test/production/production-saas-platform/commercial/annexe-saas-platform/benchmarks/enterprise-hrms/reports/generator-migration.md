...
- Capabilities: `authentication`, `users`, `roles`, `permissions`, `dashboard`, `hrms`, `notifications`, `audit-logs`, `email`, `file-storage`, `settings`, `search`, `reports`, `health`, `version`, `logging`
