...
- Capabilities: `authentication`, `users`, `roles`, `permissions`, `dashboard`, `school`, `notifications`, `audit-logs`, `email`, `file-storage`, `settings`, `search`, `reports`, `health`, `version`, `logging`
